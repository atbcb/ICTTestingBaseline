...
-   Testing synchronized media is different from testing [Baseline 16. Audio-Only and Video-Only content](https://ictbaseline.access-board.gov/document-baselines/16AudioVideoDocs).

...
-   [F83: Failure of Success Criterion 1.4.3 and 1.4.6 due to using background images that do not provide sufficient contrast](https://www.w3.org/WAI/WCAG21/Techniques/failures/F83.html) with foreground text (or images of text)

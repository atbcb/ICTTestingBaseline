...
| 13. Content Structure | Limitations, Assumptions, Exceptions: Added "While an unordered list structure is often used to create navigation menus, menus can be created using other techniques such as `<nav>`. The test for Visually Apparent Lists does not include navigation menus." |

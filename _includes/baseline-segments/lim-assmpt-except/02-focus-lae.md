...
<ul>
    ...
    <li><a href="https://www.w3.org/TR/WCAG22/#dfn-change-of-context">Changes of context</a> are major changes that, if made without user awareness, can disorient users who are not able to view the entire page simultaneously. Changes in context include changes of:
        ...
        <ul>
            ...
            <li><strong>Examples:</strong> Opening a new window, moving focus to a different component, going to a new {% if page.source == "Web" %}page{elsif page.source == "Doc" %}document{% endif %} or window (including anything that would look to a user as if they had moved to a new page) or significantly re-arranging the content of a page/screen are examples of changes of context.</li>
        </ul>
    </li>
</ul>

...
### Test Instructions
1. Check that the Web page or software provides a programmatic event notification of each change (e.g., using ARIA live regions or otherwise raising the event to the accessibility API).

...
* [WCAG SC 1.4.2 Audio Control](https://www.w3.org/TR/UNDERSTANDING-WCAG20/visual-audio-contrast-dis-audio.html) -- If any audio [in software or] on a Web page plays automatically for more than 3 seconds, either a mechanism is available to pause or stop the audio, or a mechanism is available to control audio volume independently from the overall system volume level.
  * Note 1: Since any content that does not meet this success criterion can interfere with a user's ability to use the whole page [or software application], all content [in the software or] on the Web page (whether or not it is used to meet other success criteria) must meet this success criterion. See Conformance Requirement 5: Non-Interference.
...
* Per Conformance Requirement 5, all content [in the software application or] on the Web page (whether or not it is used to meet other success criteria) must meet SC 1.4.2 and SC 2.2.2
...
* Changing content is considered to be "in parallel" when it appears alongside other content. For example, a news flash updating across the bottom of a web page or software screen would be considered changing content in parallel with other content when the page/screen also presents a news video and text news articles (both examples of static content). A button allowing users to pause the changing content would not be considered other static content.
...
### Test Instructions
1. Check that either
    1. a mechanism is available at the beginning of the page/screen content or in platform accessibility features to pause or stop the audio, **OR**
    1. a mechanism is available at the beginning of the page/screen content or in platform accessibility features to control audio volume independently from the overall system volume level.
